...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	q := Queries{db: db}
	var err error
	if q.createCashFlowEntrieStmt, err = db.PrepareContext(ctx, createCashFlowEntrie); err != nil {
		return nil, fmt.Errorf("error preparing query CreateCashFlowEntrie: %w", err)
	}
	...
	if q.updateComissionStmt, err = db.PrepareContext(ctx, updateComission); err != nil {
		return nil, fmt.Errorf("error preparing query UpdateComission: %w", err)
	}
	...
	if q.updateFlowBalanceStmt, err = db.PrepareContext(ctx, updateFlowBalance); err != nil {
		return nil, fmt.Errorf("error preparing query UpdateFlowBalance: %w", err)
	}
...
func (q *Queries) Close() error {
	var err error
	if q.createCashFlowEntrieStmt != nil {
		if cerr := q.createCashFlowEntrieStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing createCashFlowEntrieStmt: %w", cerr)
		}
	}
	...
	if q.findComissionByUserIdStmt != nil {
		if cerr := q.findComissionByUserIdStmt.Close(); cerr != nil {
	...
	if q.updateComissionStmt != nil {
		if cerr := q.updateComissionStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing updateComissionStmt: %w", cerr)
		}
	}
	if q.updateComissionValueStmt != nil {
		if cerr := q.updateComissionValueStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing updateComissionValueStmt: %w", cerr)
		}
	}
	if q.updateFlowBalanceStmt != nil {
		if cerr := q.updateFlowBalanceStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing updateFlowBalanceStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	updateFlowBalanceStmt                       *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		updateFlowBalanceStmt:                       q.updateFlowBalanceStmt,
